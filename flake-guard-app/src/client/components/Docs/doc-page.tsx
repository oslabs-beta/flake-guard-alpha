  ...
  return (
    <>
      ...
      <div className="docs-container">
        ...
        <p>Flake-Guard is a free, open-source tool designed for developers 
          to run Jest tests, automatically detecting, reporting, and managing 
          flaky tests in software development</p>
        <h1>
          Quickstart
                 </h1>{' '}
        {'Installation: '}
